...
*** Solving congruences 				    :B_example:BMCOL:
    ...
    | $4$  | $1$   | $1$   | $-55$ |
    | $5$  | $0$   | $3$   | --    |
*** $\usebeamercolor{block title}\color{fg}23x\equiv 4 \pmod{211}$ 		    :B_example:BMCOL:
    :PROPERTIES:
    :BEAMER_env: example
    :BEAMER_col: 0.45
    :END:
...
*** Operations 						       :B_definition:
    ...
    this set.
*** $\usebeamercolor{block title}\color{fg}\Z_3,+$						    :B_example:BMCOL:
    :PROPERTIES:
    :BEAMER_env: example
    :BEAMER_col: 0.45
    :END:
...
*** $\usebeamercolor{block title}\color{fg}\Z_3,\cdot$ 				    :B_example:BMCOL:
    :PROPERTIES:
    :BEAMER_env: example
    :BEAMER_col: 0.45
    :END:
...
** Example
*** $\usebeamercolor{block title}\color{fg}\Z_4,+$ 				    :B_example:BMCOL:
    :PROPERTIES:
    :BEAMER_env: example
    :BEAMER_col: 0.45
    :END:
...
*** $\usebeamercolor{block title}\color{fg}\Z_4,\cdot$ 				    :B_example:BMCOL:
    :PROPERTIES:
    :BEAMER_env: example
    :BEAMER_col: 0.45
    :END:
...
** Euler's totient $\usebeamercolor{block title}\color{fg}\varphi$ function
...
*** Calculating the $\usebeamercolor{block title}\color{fg}\varphi(n)$			  :B_theorem:
    :PROPERTIES:
    :BEAMER_env: theorem
    :END:
     ...
     \right) \]
*** Calculating the $\usebeamercolor{block title}\color{fg}\varphi(n)$			  :B_example:
    :PROPERTIES:
    :BEAMER_env: example
    :END:
